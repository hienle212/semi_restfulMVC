...
routes['/add'] = 'Products#new'
routes['/edit/<product_id>'] = 'Products#edit'
routes['/show/<product_id>'] = 'Products#show'
routes['POST']['/products/new'] = 'Products#create'
routes['POST']['/products/update'] = 'Products#update'
routes['/remove/<product_id>'] = 'Products#destroy'
"""
